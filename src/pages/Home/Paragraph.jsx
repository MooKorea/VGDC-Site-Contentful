  ...
  return (
    <header className="home-paragraph-container">
      <div className="home-paragraph">
        ...
        <picture>
            <source media="(max-width: 499px)" srcSet="/images/home/VGDC_Home_Photo_500w.webp" type="image/webp" />
            <source media="(min-width: 500px)" srcSet="/images/home/VGDC_Home_Photo.webp" type="image/webp" />
